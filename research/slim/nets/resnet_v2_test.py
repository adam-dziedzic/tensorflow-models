    ...
    for block in range(1, 5):
      for unit in range(1, 4 if block < 4 else 3):
        for conv in range(1, 4):
          expected.append('nets/block%d/unit_%d/bottleneck_v2/conv%d' %
                          (block, unit, conv))
        expected.append('nets/block%d/unit_%d/bottleneck_v2' % (block, unit))
      expected.append('nets/block%d/unit_1/bottleneck_v2/shortcut' % block)
